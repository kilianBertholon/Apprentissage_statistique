...
```{r}
all_data_2 <- all_data |> filter(Poste_globale == "Attaquant")
...
set.seed(123)
data_split <- initial_split(all_data_xg, prop = 0.75, strata = Note)
...
xgb_grid <- expand.grid(tree_depth=c(2,3,4,5,6,7),learn_rate=c(0.01,0.015,0.02,0.025))
...
gg_plot_att <- ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = Note)) +
  geom_point() +
...
```{r}
all_data_2 <- all_data |> filter(Poste_globale == "Milieu")
all_data_xg <- subset(all_data_2, select = -c(nom, Poste, Club, Annee, Poste_globale))
all_data_xg <- na.omit(all_data_xg, cols = "Note")
...
# Créer le plot ggplot2 avec médiane et intervalles de confiance
gg_plot_mil <- ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = Note)) +
  geom_point() +
  geom_hline(yintercept = median_diff, linetype = "dashed", color = "black", size = 1) +
  geom_hline(yintercept = ci_low, linetype = "dashed", color = "black", size = 0.5)+ 
  geom_hline(yintercept = ci_high, linetype = "dashed", color = "black", size = 0.5)+ 
...
```{r}
all_data_2 <- all_data |> filter(Poste_globale == "Défenseur")
all_data_xg <- subset(all_data_2, select = -c(nom, Poste, Club, Annee, Poste_globale))
all_data_xg <- na.omit(all_data_xg, cols = "Note")
...
xgb_grid <- expand.grid(tree_depth=c(2,3,4,5,6,7),learn_rate=c(0.0225,0.025,0.0275,0.03,0.0325,0.0350))
...
# Créer le plot ggplot2 avec médiane et intervalles de confiance
gg_plot_def <- ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = Note)) +
  geom_point() +
  geom_hline(yintercept = median_diff, linetype = "dashed", color = "black", size = 1) +
  geom_hline(yintercept = ci_low, linetype = "dashed", color = "black", size = 0.5)+ 
  geom_hline(yintercept = ci_high, linetype = "dashed", color = "black", size = 0.5)+ 
...
```{r}
all_data_2 <- all_data |> filter(Poste_globale == "Gardien")
all_data_xg <- subset(all_data_2, select = -c(nom, Poste, Club, Annee, Poste_globale))
all_data_xg <- na.omit(all_data_xg, cols = "Note")
...
# Créer le plot ggplot2 avec médiane et intervalles de confiance
gg_plot_gardien <- ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = Note)) +
  geom_point() +
  geom_hline(yintercept = median_diff, linetype = "dashed", color = "black", size = 1) +
  geom_hline(yintercept = ci_low, linetype = "dashed", color = "black", size = 0.5)+ 
  geom_hline(yintercept = ci_high, linetype = "dashed", color = "black", size = 0.5)+ 
...
xgb_grid <- expand.grid(tree_depth=c(2,3,4,5,6,7),learn_rate=c(0.0200,0.0205,0.0210,0.215,0.2200,.02255))
