...
```{r}
all_data <- all_data |> filter(Poste_globale == "Attaquant")
...
# Plot avec ggplot2
ggplot(data_test_fin_2, aes(x = .pred, y = Difference)) +
  geom_point() +
  labs(title = "Différence entre les valeurs prédites et réelles",
       x = "Valeurs Prédites",
       y = "Différence")


ggplot(data_test_fin_2, aes(x = Difference)) +
  geom_histogram(binwidth = 0.01, fill = "blue", color = "black", alpha = 0.7) +
  labs(title = "Distribution des différences entre les valeurs prédites et réelles",
       x = "Différence",
       y = "Fréquence")

ggplot(data_test_fin_2, aes(x = .pred, y = Note)) +
  geom_point() +
  labs(title = "Différence entre les valeurs prédites et réelles",
       x = "Valeurs Prédites",
       y = "Note")
...
ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = ifelse(Difference >= 0, "green", "red"))) +
  geom_point() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "black", size = 1) +
  labs(title = "Différence entre les valeurs prédites et réelles par individu",
       x = "Individu",
       y = "Différence") +
...
gg_plot <- ggplot(data_test_fin_2, aes(x = rownames(data_test_fin_2), y = Difference, color = Note)) +
  ...
  labs(title = "Différence entre les valeurs prédites et réelles par individu pour la population attaquant",
       x = "Individu",
       y = "Différence") +
